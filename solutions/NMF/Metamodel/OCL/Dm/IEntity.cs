...
namespace TTC2021.OclToSql.Ocl.Dm
{
    ...
    /// <summary>
    /// The public interface for Entity
    /// </summary>
    [DefaultImplementationTypeAttribute(typeof(Entity))]
    [XmlDefaultImplementationTypeAttribute(typeof(Entity))]
    [ModelRepresentationClassAttribute("http://www.example.org/ocl#//dm/Entity")]
    public interface IEntity : IModelElement
    {
        ...
        [ConstantAttribute()]
        IOrderedSetExpression<IAssociationEnd> Ends
        {
            get;
        }
        ...
        [ContainmentAttribute()]
        [ConstantAttribute()]
        IOrderedSetExpression<TTC2021.OclToSql.Ocl.Dm.IAttribute> Attributes
        {
            get;
        }
