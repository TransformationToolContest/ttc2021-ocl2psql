...
namespace TTC2021.OclToSql.Sql
{
    ...
    /// <summary>
    /// The default implementation of the Alias class
    /// </summary>
    ...
    [DebuggerDisplayAttribute("Alias {Name}")]
    public partial class Alias : ModelElement, IAlias, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.example.org/sql#//Alias")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2021.OclToSql.Sql.Alias.ClassInstance)).Resolve("name")));
        }
        ...
        /// </summary>
        private sealed class NameProxy : ModelPropertyChange<IAlias, string>
        {
            ...
            public NameProxy(IAlias modelElement) : 
