...
namespace TTC2021.OclToSql.Sql
{
    ...
    /// <summary>
    /// The default implementation of the SelectStatement class
    /// </summary>
    [XmlNamespaceAttribute("http://www.example.org/sql")]
    [XmlNamespacePrefixAttribute("sql")]
    [ModelRepresentationClassAttribute("http://www.example.org/sql#//SelectStatement")]
    public partial class SelectStatement : ModelElement, ISelectStatement, IModelElement
    {
        ...
        public override IEnumerableExpression<IModelElement> Children
        {
            get
            {
                return base.Children.Concat(new SelectStatementChildrenCollection(this));
            }
        }
        ...
        public override IEnumerableExpression<IModelElement> ReferencedElements
        {
            get
            {
                return base.ReferencedElements.Concat(new SelectStatementReferencedElementsCollection(this));
            }
        }
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.example.org/sql#//SelectStatement")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2021.OclToSql.Sql.SelectStatement.ClassInstance)).Resolve("selectBody")));
        }
        ...
        /// <summary>
        /// The collection class to to represent the children of the SelectStatement class
        /// </summary>
        public class SelectStatementChildrenCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            
            private SelectStatement _parent;
            
            /// <summary>
            /// Creates a new instance
            /// </summary>
            public SelectStatementChildrenCollection(SelectStatement parent)
            {
                this._parent = parent;
            }
            ...
            {
                return Enumerable.Empty<IModelElement>().Concat(this._parent.SelectBody).GetEnumerator();
            }
        }
        ...
        /// The collection class to to represent the children of the SelectStatement class
        /// </summary>
        public class SelectStatementReferencedElementsCollection : ReferenceCollection, ICollectionExpression<IModelElement>, ICollection<IModelElement>
        {
            ...
            /// Creates a new instance
            /// </summary>
            public SelectStatementReferencedElementsCollection(SelectStatement parent)
            {
                this._parent = parent;
            }
        ...
        /// </summary>
        private sealed class SelectBodyProxy : ModelPropertyChange<ISelectStatement, IPlainSelect>
        {
            ...
            public SelectBodyProxy(ISelectStatement modelElement) : 
