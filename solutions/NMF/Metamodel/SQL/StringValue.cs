...
namespace TTC2021.OclToSql.Sql
{
    ...
    /// <summary>
    /// The default implementation of the StringValue class
    /// </summary>
    [XmlNamespaceAttribute("http://www.example.org/sql")]
    [XmlNamespacePrefixAttribute("sql")]
    [ModelRepresentationClassAttribute("http://www.example.org/sql#//StringValue")]
    public partial class StringValue : Expression, IStringValue, IModelElement
    {
        ...
        public new static IClass ClassInstance
        {
            get
            {
                ...
                {
                    _classInstance = ((IClass)(MetaRepository.Instance.Resolve("http://www.example.org/sql#//StringValue")));
                }
        ...
        {
            return ((ITypedElement)(((ModelElement)(TTC2021.OclToSql.Sql.StringValue.ClassInstance)).Resolve("value")));
        }
        ...
        /// </summary>
        private sealed class ValueProxy : ModelPropertyChange<IStringValue, string>
        {
            ...
            public ValueProxy(IStringValue modelElement) : 
